...
bash: _create_bash_link
fish: _create_fish_link
help: _display_help_message
install: _create_vim_link _create_bash_link _create_tmux_link _create_fish_link _install-ansible _run-provision
...
_display_help_message:
	...
	@echo "  bash \t\t create bash symlinks"
